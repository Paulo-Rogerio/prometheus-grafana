...
INFO = Gauge(
    "http_app_info", "Http application information.", ["app_name"]
)
REQUESTS = Counter(
    "http_requests_total", "Total count of requests by method and path.", [
...
class PrometheusMiddleware(BaseHTTPMiddleware):
    def __init__(self, app: ASGIApp, app_name: str = "frontend") -> None:
        super().__init__(app)
